...
class tx_additionalreports_main {
	...
	public static function getCss() {
		return t3lib_extMgm::siteRelPath('additional_reports') . 'res/css/tx_additionalreports.css';
	}
	...
	public function displayXclass() {
		...
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/xclass.html');
	...
	public function displayAjax() {
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/ajax.html');
	...
	public function displayCliKeys() {
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/clikeys.html');
	...
	public function displayEid() {
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/eid.html');
	...
	public function displayExtDirect() {
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/extdirect.html');
	...
	public function displayExtensions() {
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/extensions.html');
			...
			foreach ($items as $itemKey => $itemValue) {
				if (t3lib_extMgm::isLoaded($itemKey)) {
					...
					if (!$lastVersion) {
						...
						// need extconf update
						$absPath = tx_additionalreports_util::getsiteRelPath($extKey, $extInfo['type']);
	...
	public function displayHooks() {
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/hooks.html');
	...
	public function displayStatus() {
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/status.html');
	...
	public function displayPlugins() {
		...
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/plugins.html');
	...
	public function displayRealUrlErrors() {
		...
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/realurlerrors.html');
		$markersArray = array();
	...
	public function displayLogErrors() {
		...
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/logerrors.html');
		$markersArray = array();
	...
	public function displayWebsitesConf() {
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/websiteconf.html');
		$markersArray = array();
	...
	public function displayDbCheck() {
		$template = new tx_additionalreports_templating();
		$template->initTemplate(t3lib_extMgm::siteRelPath('additional_reports') . 'res/templates/dbcheck.html');
